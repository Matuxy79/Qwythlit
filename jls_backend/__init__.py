"""jls_backend — the retrieval, caching, and carrier sub-package for John's Light Source (JLS).

This package contains everything below the service layer (``jls_service.py``).
